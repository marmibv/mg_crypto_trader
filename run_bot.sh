...
ssh -f marcelo@192.168.31.161 '/home/marcelo/des/mg_crypto_trader/.env/bin/python3.10 /home/marcelo/des/mg_crypto_trader/.  -run-bot -calc-rsi -start-train-date=2023-06-01 -all-cols -regression-times=0 -stop-loss=3 -estimator=knn -symbol=AVAXSDT > /home/marcelo/des/mg_crypto_trader/bot_AVAXSDT.log'
ssh -f marcelo@192.168.31.161 '/home/marcelo/des/mg_crypto_trader/.env/bin/python3.10 /home/marcelo/des/mg_crypto_trader/.  -run-bot -calc-rsi -start-train-date=2023-06-01 -all-cols -regression-times=0 -stop-loss=3 -estimator=knn -symbol=BCHUSDT > /home/marcelo/des/mg_crypto_trader/bot_BCHUSDT.log'
ssh -f marcelo@192.168.31.161 '/home/marcelo/des/mg_crypto_trader/.env/bin/python3.10 /home/marcelo/des/mg_crypto_trader/.  -run-bot -calc-rsi -start-train-date=2023-06-01 -all-cols -regression-times=0 -stop-loss=3 -estimator=knn -symbol=MATICUSDT > /home/marcelo/des/mg_crypto_trader/bot_MATICUSDT.log'
ssh -f marcelo@192.168.31.161 '/home/marcelo/des/mg_crypto_trader/.env/bin/python3.10 /home/marcelo/des/mg_crypto_trader/.  -run-bot -calc-rsi -start-train-date=2023-06-01 -all-cols -regression-times=0 -stop-loss=3 -estimator=knn -symbol=TRXUSDT > /home/marcelo/des/mg_crypto_trader/bot_TRXUSDT.log'
